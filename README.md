...
Backend Developer focused on **C# & .NET ecosystem**.  
I enjoy building **clean, scalable APIs**, working with **real-time systems**, and building **AI-powered backend solutions**.
...
### 🟣 Evtap.az — Real Estate Platform with AI Analysis
- Real estate listings management system
- AI-based **price analysis & market insights**
...
- Backend performance & logging improvements
